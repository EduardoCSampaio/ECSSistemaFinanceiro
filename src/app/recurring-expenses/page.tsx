...
export default function RecurringPage() {
  ...
  return (
    <div className="flex flex-1 flex-col gap-4 md:gap-8">
      <div className="flex items-center">
        <h1 className="text-lg font-semibold md:text-2xl">Despesas Recorrentes</h1>
        <div className="ml-auto flex items-center gap-2">
      ...
      <Card>
        <CardHeader>
            ...
            <CardDescription>Suas contas e despesas que se repetem mensalmente.</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
